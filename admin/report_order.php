                ...
                <main>
                    <div class="container-fluid px-4 ">
                        ...
                        <div class="card mb-4 mt-4">
                            ...
                            <div> 
                                <br>
                                <a href="report_order_yes.php"><button type="button" class="btn btn-outline-info">ชำระเงินแล้ว</button> </a>
                                <a href="report_order.php"><button type="button" class="btn btn-outline-info">ยังไม่ชำระเงิน</button> </a>
                                <a href="report_order_no.php"><button type="button" class="btn btn-outline-info">ยกเลิกใบสั่งซื้อ</button> </a>
                            </div>
                            <br>
                            <div>
...
?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="report_order_detail.php?id=<?=$row['orderID']?>" class="btn btn-secondary" > รายละเอียด</a></td>  
